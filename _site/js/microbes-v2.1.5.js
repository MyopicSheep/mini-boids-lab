 ...
 * @version: 2.1.5
 * @description: Animated microbes inspired by Craig Reynolds' Boids,
...
function microbesGo() {
    ...
    var canvasSupport = !!document.createElement('canvas').getContext,
        ...
        ctx,
        isPaused = true,
        myCanvas = document.getElementById('microbes');
    
    
    function styleCanvas(canvas, element) {
        canvas.style.backgroundColor = "#162252";
    ...
    function Boid() {
        ...
        this.maxspeed = 1 + Math.random() * 0.5;
    }
    ...
    Boid.prototype.render = function () {
        ...
        ctx.lineWidth = 1;
        ctx.strokeStyle = "rgba(4, 61, 160, 0.8)";
    ...
    function drawBoids() {
        ...
        if (!isPaused) {
            ...
            document.getElementById('microbes').firstChild.style.opacity = "1";
    ...
    function checkView() {
        ...
        var page = document.getElementById('microbes').firstChild;
        if (isElementInViewport(page) && isPaused === true) {
            isPaused = false;
            drawBoids();
   ...
   // Monitors opportunities to pause or draw animation.
    function draw() {
        ...
        window.addEventListener('scroll', function () {
            ...
            window.scrollFinished = setTimeout(checkView, 300);
        }, false);
        ...
        window.addEventListener('resize', function () {
            setTimeout(function () {
                var newCanvas = document.getElementById("microbes");
    ...
    function init() {
        ...
        page = document.getElementById('microbes').firstChild;
        
        // Set up the boids (microbes) to draw
...
// Only run if the page contains an element tagged with microbes id.
// Allow 100ms for any page transitions to occur before starting
// the animation.
window.addEventListener('load', function () {
    "use strict";
    if (document.getElementById('microbes')) {
        clearTimeout(document.animationStart);
        document.animationStart = setTimeout(microbesGo, 100);
    }
});
